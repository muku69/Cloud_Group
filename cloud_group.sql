...
INSERT INTO `hobbies` VALUES ('Listening to music',10,1),('Traveling',10,2),('Taking a picture',10,3),('Photography',20,7),('Collecting Toy Cars',20,8),('Playing Music',20,9),('I want to become a certified s',62,28),('I want to become a certified s',62,29),('I want to become a certified s',62,30),('I want to become a certified s',57,34),('I want to become a certified s',57,35),('I want to become a certified s',57,36),('ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚',75,40),('ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚',75,41),('ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚ã‚',75,42),('Dance',80,43),('Mobile Game',80,44),('Baseball',80,45),('éŸ³æ¥½é‘‘è³ž',76,46),('ãƒ†ãƒ‹ã‚¹',76,47),('æ•£æ­©',76,48),('æ˜ ç”»é‘‘è³ž',77,49),('æ–™ç†',77,50),('æµ·å¤–æ—…è¡Œ',77,51),('Soccer',78,52),('Traveling',78,53),('Hiking',78,54),('Bascketball',79,55),('Eating',79,56),('Stamp Collecting',79,57),('Cooking',81,58),('Badminton',81,59),('Listening to music',81,60);
...
INSERT INTO `sns` VALUES (10,1,'https://www.instagram.com/mukku_0407/','https://twitter.com/photo_mukku','https://www.facebook.com/takumi.miyamoto.9'),(10,2,'https://www.instagram.com/mukku_0407/','https://twitter.com/photo_mukku','https://www.facebook.com/takumi.miyamoto.9'),(10,3,'https://www.instagram.com/mukku_0407/','https://twitter.com/photo_mukku','https://www.facebook.com/takumi.miyamoto.9'),(20,5,'https://www.instagram.com/ryandupay/','https://twitter.com/ryandupay','https://www.facebook.com/ryan.dupay'),(62,12,'','',''),(57,14,'','','https://www'),(75,16,'','',''),(80,17,'https://www.instagram.com/coldplay/','https://twitter.com/herbieyamaguchi','https://www.facebook.com/abenn.sala'),(76,18,'https://www.instagram.com/sade/','https://twitter.com/SadeOfficial','https://www.facebook.com/yuichi.kimura.359'),(77,19,'https://www.instagram.com/oasis/','https://twitter.com/mamamilk_info','https://www.facebook.com/rena.adachi.10'),(78,20,'https://www.instagram.com/katyperry/','https://twitter.com/fatbellybella','https://www.facebook.com/keita.minami.5'),(79,21,'https://www.instagram.com/selenagomez/','https://twitter.com/missjillscott','https://www.facebook.com/jikogwapo'),(81,22,'https://www.instagram.com/maxwell/','https://twitter.com/_MAXWELL_','https://www.facebook.com/applejoy.d.lumogdang?ref=');
...
INSERT INTO `work_experience` VALUES ('AHGS','Sales manager','2017-07-19','2017-07-12',10,1),('QQ','QA engineer','2017-07-18','2017-07-19',10,2),('NEC Telecom Software Philippines','SeniorSoftware Tester','2008-06-16','2016-07-15',20,5),('Framgia Philippines','QA Manager','2016-08-22','0000-00-00',20,6),('Nagoya Designer GakuinNagoya DNagoya Designer Gaku','Nagoya Designer GakuinNagoya D','2017-07-18','2017-07-07',62,19),('Nagoya Designer GakuinNagoya DNagoya Designer Gaku','Nagoya Designer GakuinNagoya D','0000-00-00','0000-00-00',62,20),('','','0000-00-00','0000-00-00',57,23),('','','0000-00-00','0000-00-00',57,24),('','','0000-00-00','0000-00-00',75,27),('','','0000-00-00','0000-00-00',75,28),('Spotify','Accountant','1993-05-09','1999-03-12',80,29),('2GO Philippines','Accountant','2000-05-06','2010-10-25',80,30),('ãƒˆãƒ¨ã‚¿è‡ªå‹•è»Šæ ªå¼ä¼šç¤¾','å–¶æ¥­','2007-04-07','2013-07-16',76,31),('å‘³ã®ç´ æ ªå¼ä¼šç¤¾','å–¶æ¥­','2013-09-01','2015-06-24',76,32),('æ ªå¼ä¼šç¤¾NTTãƒ‰ã‚³ãƒ¢','çµŒç†','2012-04-01','2012-08-30',77,33),('æ ªå¼ä¼šç¤¾ã‚ªãƒªã‚¨ãƒ³ã‚¿ãƒ«ãƒ©ãƒ³ãƒ‰','ä¼ç”»é–‹ç™º','2012-09-01','2014-03-17',77,34),('Sony Corporation','Sales staff','2014-04-01','2015-03-16',78,35),('Panasonic Corporation','Sales manager','2015-04-01','2016-05-28',78,36),('Amazon.com Inc.','QA enginner ','2012-07-04','2014-12-31',79,37),('GMA Network, Inc.','Project manager','2015-03-14','2017-01-30',79,38),('BlackBerry Limited','Secretary','1998-02-10','2006-05-30',81,39),('Asia United Bank','Japanese HR Associate','2007-07-01','2014-12-31',81,40);
...
-- Dump completed on 2017-08-14  9:32:02
